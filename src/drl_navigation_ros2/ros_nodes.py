...
class MarkerPublisher(Node):
    ...
    def publish(self, x, y):
        ...
        self.get_logger().info(f"Published marker at ({x}, {y}) with frame_id: {marker.header.frame_id}")
        #print(f"Published marker at ({x}, {y}) with frame_id: {marker.header.frame_id}")
